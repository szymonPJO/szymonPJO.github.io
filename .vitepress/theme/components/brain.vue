...
<template>
  ...
  <div class="animation">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 650 600">
      <g>
        <g id="a" fill="none" stroke-linejoin="round" stroke="currentcolor" stroke-width="4.3" stroke-linecap="round">
          <path id="brainBg"
