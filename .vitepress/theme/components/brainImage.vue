...
<template>
  ...
  <div id="brainImg-div">
    ...
    <svg id="brainImg-svg" viewBox="0 0 650 650" preserveAspectRatio="none">
      <g id="brainImg-bg" class="brainImg-group-scale">
        <path id="brainImg-bg-half"
        ...
        <g>
          <use transform="matrix(-1 0 0 1 640 0)" xlink:href="#brainImg-bg-half" />
        </g>
      </g>
      ...
      <mask id="brainMask">
        ...
        <g class="brainImg-group-scale">
          <g id="_brainImg-half-path" stroke-linejoin="round" stroke="var(--brain-mask-stroke-opacity)" fill="wtf"
            opacity="1" stroke-width="5" stroke-linecap="round">
            <path id="brainImg-bg-path"
              d="m 474,194.1 c 1.2,-10.6 -0.5,-21.5 -4.9,-31.2 -6.4,-14.2 -18.5,-25.7 -33,-31.4 -1.9,-6.7 -5.7,-12.8 -10.9,-17.5 -7.3,-6.6 -17.2,-10.1 -27,-9.6 -3.5,-6.16 -8.6,-11.38 -14.7,-14.93 -7.9,-4.57 -17.3,-6.34 -26.3,-4.88 -9,1.45 -17.4,6.11 -23.4,12.96 -5.1,5.85 -8.3,13.05 -10,20.65 -1.7,7.5 -1.7,15.3 -1.7,23 l 1.3,224.6 c 0.1,17 2.3,33.9 3.7,50.8 1.3,15.9 0.7,32 -0.8,47.9 -0.8,8.7 -2,17.5 -2,26.3 0,8.7 1.1,17.7 4.7,25.7 5.2,11.9 15.5,21.1 27,27 22,11.3 49.4,11.3 71.5,0.2 19.8,-10 35.1,-28.5 41.1,-49.9 8.9,-3.1 16.9,-8.7 22.9,-15.9 5.9,-7.3 9.8,-16.3 11.1,-25.6 1,-7.5 0.3,-15.3 -2,-22.5 2.7,-3.9 5,-8.1 6.7,-12.5 5.3,-13.6 5,-29.3 -0.6,-42.8 9.4,-7.4 16.5,-17.7 19.9,-29.2 3.3,-11.5 3,-24 -0.9,-35.3 -4.4,-12.7 -13.4,-23.7 -25,-30.6 6.2,-17.3 5.6,-37 -1.6,-53.9 C 493.8,213 485,202 474,194.1 Z" />

            <path id="brain-anim-paths" opacity="1" fill="transparent" color="wtf"
          ...
          <g>
            <use transform="matrix(-1 0 0 1 640 0)" xlink:href="#_brainImg-half-path" />
          </g>
        </g>
      </mask>
...
#brainImg-bg {
  stroke-width: var(--brain-stroke-width);
  stroke: var(--vp-c-bg);
  fill: var(--vp-c-bg);
  /* #f8efef */

  filter: drop-shadow(30px 10px 4px #0004) drop-shadow(0 0 100mm #7e580d1a);
}
...
#brainImg-bg-path {
  ...
  fill: var(--brain-mask-bg-opacity);
}

#brain-anim-paths {
  animation: waves 100s linear infinite;
}
